...
if __name__ == '__main__':
    import os as _os
    debug = _os.environ.get('FLASK_ENV', 'production') == 'development'

    print("🚀 Bachat AI ML API starting...")
    print("   Endpoints:")
    print("   GET  /health")
    print("   POST /api/categorize")
    print("   POST /api/categorize/batch")
    print("   POST /api/forecast")
    print("   POST /api/anomaly")
    print("   POST /api/analyze      ← main endpoint")
